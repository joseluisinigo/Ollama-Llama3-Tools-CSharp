...
namespace Tools.Messages
{
    public static class MessageManager
    {
        private static readonly Dictionary<string, string> messages = new Dictionary<string, string>
        {
            ...
            { "get_system_info", SystemInfoMessage.GetMessage() }
        };
        ...
        public static string GetUserMessage(string toolName)
        {
            return toolName switch
            {
                ...
                "get_system_info" => "Usa la herramienta 'get_system_info' para mostrar información sobre el espacio en disco y rendimiento del sistema.",
